...
export default function Home () {
    ...
    const [arr, setArr] = React.useState([...blogs]);

    function addNewBlog(blog) {
        setArr([...arr, blog]);
    }
    <Compose addOnn={addNewBlog} />
            ...
            <section className="header">
                <div className="wrapper w-row" id="header">
                    <div className="w-col wrap-img1">
                        <img className="header-img" src="https://try.mekshq.com/u/byhhj/wp-content/uploads/2019/03/art-art-materials-artist-914922-540x540.jpg" alt="" />
                    </div>
            ...
            <section className="blogs">
                ...
                <div className="blog-section">
                    <div className="blog-wrap wrapper">
                        {arr.map((blog, index) => {
                            return <Blogcard addOnn={addNewBlog} key = {index} imgsrc = {blog.imgsrc} title = {blog.title}author = {blog.author}date = {blog.date}/>;
                        })}
                    </div>
